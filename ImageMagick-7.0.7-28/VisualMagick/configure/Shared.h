...
static inline vector<wstring> test()
{
	//mm.zhang
	vector<wstring> validSrcFiles;
	validSrcFiles.push_back(L".c");
	validSrcFiles.push_back(L".cpp");
	validSrcFiles.push_back(L".cc");
	return validSrcFiles;
}
const vector<wstring> validSrcFiles = test();
